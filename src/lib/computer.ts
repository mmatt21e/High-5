...
export const COMPUTER_LEVELS = ["easy", "medium", "hard"] as const;
export type ComputerLevel = (typeof COMPUTER_LEVELS)[number];

export const COMPUTER_OPPONENTS = {
  easy: { name: "Lucky Guppy", skill: "Relaxed", description: "Unpredictable plays. A forgiving table for learning the ropes.", avatar: "avatar:frog" },
  medium: { name: "Sneaky Stacker", skill: "Strategic", description: "Builds combinations and protects a decent concealed hand.", avatar: "avatar:fox" },
  hard: { name: "The Cardfather", skill: "Advanced", description: "Studies your visible rows and weighs possible outcomes before playing.", avatar: "avatar:spade" },
